...
<script>
import { fetchAllList, getDetail, fetchExportList } from '@/api/equipSpareParts/addPartsApply'
import { recordList, processChart } from '@/api/common/common'
...
export default {
  ...
  methods: {
    ...
    getRoutParams() {
      ...
      this.listQuery.checkStatus = this.routMsg.checkStatus
