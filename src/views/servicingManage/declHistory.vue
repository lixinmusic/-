           ...
           <h2 style="text-align:center;">{{srintList.repairCompany}}设备报修单</h2>
            ...
            <tbody>
              <tr style="height:60px">
                <td>设备名称</td>
                <td colspan="3">{{srintList.equipmentName}}</td>
                <td colspan="3">固定资产编号</td>
                <td colspan="1">{{srintList.fixedAssetCode}}</td>
              </tr>
             
              <tr style="height:60px">
                <td>型号规格</td>
                <td colspan="3">{{srintList.model}}</td>
                <td colspan="3">报修时间</td>
                <td colspan="1">{{srintList.repariDate}}</td>
              </tr>
               <tr style="height:60px">
                <td>电路板名称</td>
                <td colspan="3">{{srintList.circuitBoardName}}</td>
                <td colspan="3">电路板型号</td>
                <td colspan="1">{{srintList.circuitBoardModel}}</td>
              </tr >
               <tr style="height:60px">
                <td>报修部门</td>
                <td colspan="3">{{srintList.repairDivision}}</td>
                <td colspan="3">要求完成时间</td>
                <td colspan="1">{{srintList.requestDate}}</td>
              </tr>
              <tr>
              ...
              <tr style="height:100px">
                <td colspan="8" style="border-bottom:0px;" align="left" valign="top">
              ...
              <tr style="height:100px">
                <td colspan="8" align="left" valign="top" style="height:50px;border-bottom:0px solid white;">申请人意见：{{fixing}}</td>
              </tr>
              <tr style="border-top:0px solid white;">    
                <td colspan="8" align="right"><span>签字：{{fixingName}}</span><span>日期：{{fixingDate}}</span></td>
              </tr>
              <tr style="height:100px">
                <td colspan="8" align="left" valign="top" style="height:50px;border-bottom:0px solid white;">厂长审核意见：{{factoryst}}</td>
              </tr>
              <tr style="border-top:0px solid white;"> 
                <td colspan="8" align="right"><span>签字：{{factorystName}}</span><span>日期：{{factorystDate}}</span></td>
              </tr>
               <tr style="height:100px">
                <td colspan="8" align="left" valign="top" style="height:50px;border-bottom:0px solid white;">事业部分管副总意见：{{enterprise}}</td>
              </tr>
              <tr style="border-top:0px solid white;">
                <td colspan="8" align="right"><span>签字：{{enterpriseName}}</span><span>日期：{{enterpriseDate}}</span></td>
              </tr>
              <tr style="height:100px">
                <td colspan="8" align="left" valign="top" style="height:50px;border-bottom:0px solid white;">资产部意见：{{propertyst}}</td>
              </tr>
              <tr style="border-top:0px solid white;">  
                <td colspan="8" align="right"><span>签字：{{propertystName}}</span><span>日期：{{propertystDate}}</span></td>
              </tr>
...
<script>
import { fetchListdsy, evaluate, circuList, getCurrentUser, smilelist, smallAblist, updeletedata, derivationst } from '@/api/servicingManage/declHistory'
...
export default {
  ...
  methods: {
    // 导出
    derivation() {
      this.listQu.checkStart = this.listQuery.checkStart
      this.listQu.companyCode = this.listQuery.companyCode
      this.listQu.divisionCode = this.listQuery.divisionCode
      this.listQu.documnetCode = this.listQuery.documnetCode
      this.listQu.equipmentName = this.listQuery.equipmentName
      this.listQu.factoryCode = this.listQuery.factoryCode
      this.listQu.fixedAssetCode = this.listQuery.fixedAssetCode
      this.listQu.requestDateUp = this.listQuery.requestDateUp
      this.listQu.requestDateEnd= this.listQuery.requestDateEnd 
      this.listQu.startDate = this.listQuery.startDate
      this.listQu.endDate = this.listQuery.endDate

      derivationst(this.listQu).then(response => {
    ...
    alltiemw() {
      ...
      this.listQuery.checkStart = this.posyrouter.checkStatus
