       ...
       <!-- 顶部搜索 -->
        ...
        <div class="filter-container">
            ...
            <el-form :inline="true">
                ...
                <el-input v-model="listQuery.equipName" style="width:189px" placeholder="请输入设备名称" clearable></el-input>
                </el-form-item>
        ...
        <el-tabs v-model="activeName" v-loading="fromLoading" @tab-click="fathClick"><!-- @tab-click="handleClick" -->
          ...
          <!-- 选项卡表格 -->
            <el-form :rules="rules" ref="dataForm" :model="temp" label-width="110px">
              <el-form-item>
                <span class="equip-title">设备维修验收记录单已办</span>
              </el-form-item>
...
<script>
import { fetchList, smallAblist, uploadlist, circuList, updeletedata, derivationst } from '@/api/servicingManage/labelHistory'
  ...
  methods: {
    ...
    alltiemw() {
      ...
      if (this.posyrouter.startDate != '') {
        var biges = []
        const stars = this.posyrouter.startDate
