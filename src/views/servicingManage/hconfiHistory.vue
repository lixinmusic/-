        ...
        <el-tabs v-model="activeName" v-loading="fromLoading" @tab-click="fathClick"><!-- @tab-click="handleClick" -->
          ...
          <!-- 选项卡表格 -->
            <el-form :rules="rules" ref="dataForm" :model="temp" label-width="110px">
              <el-form-item>
                <span class="equip-title">设备维修质保确认单已办</span>
              </el-form-item>
...
<script>
import { fetchList, smallAblist, samllDelete, uploadlist, circuList, updeletedata,derivationst } from '@/api/servicingManage/hconfiHistory'
