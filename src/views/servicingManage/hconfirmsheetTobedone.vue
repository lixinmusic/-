        ...
        <el-tabs v-model="activeName" v-loading="fromLoading" @tab-click="fathClick"><!-- @tab-click="handleClick" -->
          ...
          <!-- 选项卡表格 -->
            <el-form :rules="rules" ref="dataForm" :model="temp" label-width="110px">
              <el-form-item>
                <span class="equip-title">设备维修质保确认单待办</span>
              </el-form-item>
             ...
             <el-row>
              ...
              <el-form-item label="验收情况" prop="acceptanceInfo" style="margin-left:120px"> 
                <el-radio v-model="temp.acceptanceInfo" :disabled='sieCo?true:false' label="1">验收通过</el-radio>
                <el-radio v-model="temp.acceptanceInfo" :disabled='sieCo?true:false' label="2">验收不通过</el-radio>
...
<script>
import { fetchList, smallAblist, samllDelete, uploadlist, circuList, updateAuditing, updeletedata, insertFile, getCurrentUser, getNodeTask, newlYupdate } from '@/api/servicingManage/hconfirmsheetTobedone'
    ...
    submData() {
      this.$refs['dataForm'].validate(valid => {
        if (valid) {
          const tempData = {
            taskId: this.temp.taskId,
            acceptanceDate: this.temp.warrantyDate,
