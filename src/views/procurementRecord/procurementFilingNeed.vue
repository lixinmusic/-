<template>
    <div class='app-container'>
        <el-container>
            ...
            <!-- 查看 -->
            <el-dialog title="查看" :close-on-click-modal="false" width="80%" :visible.sync="dialogFormVisible" v-dialogDrag :modal-append-to-body="false" v-loading="listLoading">
                <el-tabs v-model="activeName" @tab-click="handleClick">
                    <el-tab-pane label="表单信息" name="first">
                        <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="145px">
                            ...
                            <el-row :gutter="20">
                                ...
                                <el-col :span="12">
                                    <el-form-item label="项目号" prop="projectCode">
                                        <el-input v-model="temp.projectCode" maxlength="30" :disabled="dszShow"></el-input>
                                    </el-form-item>
                                </el-col>
                            </el-row>
                            <el-row :gutter="20">
                                <el-col :span="11">
                                    <el-form-item label="项目内部名称" prop="projectInsideName">
                                        <el-input v-model="temp.projectInsideName" maxlength="30" :disabled="tzsqTask"></el-input>
                                    </el-form-item>
                                </el-col>
                                <!-- 只能内勤报董事长并处理节点填写 -->
                                <el-col :span="12">
                            ...
                            <el-row :gutter="20">
                                <el-col :span="11">
                                    <el-form-item label="使用地址" prop="useAddress">
                                        <el-input v-model="temp.useAddress" placeholder="例：浙江金华市婺城仙华南街800号" maxlength="40" :disabled="tzsqTask"></el-input>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="12">
                            ...
                            <el-row :gutter="20">
                                ...
                                <el-col :span="11">
                                    <el-form-item label="设备采购完成时间" prop="equipBuyCompleteTime">
                                        <el-date-picker style="width:100%" v-model="temp.equipBuyCompleteTime" type="date" placeholder="选择时间" format="yyyy-MM-dd" value-format="yyyy-MM-dd" :picker-options="pickerOptions0" :disabled="finance">
                                        </el-date-picker>
                                    </el-form-item>
                                </el-col>
                            </el-row>
                            ...
                            <el-row :gutter="20">
                                ...
                                <el-col :span="11">
                                    ...
                                    <el-form-item label="预算" prop="budget">
                                        <el-input v-model="temp.budget" :disabled="finance"></el-input>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="12">
                                    <el-form-item label="要求交货时间" prop="requirementDeliveryTime">
                                        <el-date-picker style="width:100%" v-model="temp.requirementDeliveryTime" format="yyyy-MM-dd" value-format="yyyy-MM-dd" :picker-options="pickerOptions0" type="date" placeholder="选择时间" :disabled="tzsqTask">
                                        </el-date-picker>
                                    </el-form-item>
                                </el-col>
                            </el-row>
                            <el-row :gutter="20">
                                <el-col :span="23">
                                    <el-form-item label="申请原因" prop="applicationReason">
                                        <el-input type="textarea" :disabled="tzsqTask" maxlength="200" v-model="temp.applicationReason"></el-input>
                                    </el-form-item>
                                </el-col>
                            </el-row>
                            <el-row :gutter="20">
                                <el-col :span="23">
                                    <el-form-item label="具体要求" prop="detailRequirement">
                                        <el-input type="textarea" :disabled="tzsqTask" maxlength="200" v-model="temp.detailRequirement"></el-input>
                                    </el-form-item>
                                </el-col>
                            </el-row>
                            <el-row :gutter="20">
                            ...
                            <el-row>
                                <el-col :span="1" style="width:1px;color:red;padding:8px" v-if="jsfzrShow">
                                    <span>*</span>
                                </el-col>
                                <el-col :span="10">
                                    <el-form-item label="技术资料" prop="jszlFileData">
                                        <input id="uploadImg2" type="file" @change="fileUpload2" v-if="tzsqTask">
                                    </el-form-item>
                                </el-col>
                            </el-row>
                            ...
                            <el-row>
                                <el-col :span="1" style="width:1px;color:red;padding:8px" v-if="!dszShow">
                                    <span>*</span>
                                </el-col>
                                <el-col :span="10">
                                    <el-form-item label="审核附件" prop="fileData">
                                        <input id="uploadImg" type="file" @change="fileUpload" v-if="!dszShow">
                                    </el-form-item>
                                </el-col>
                            </el-row>
                        </el-form>
            ...
            <el-dialog title="查看闲置" :visible.sync="centerDialogVisible" width="80%" :close-on-click-modal="false" v-dialogDrag>
                ...
                <el-table :data="infoList" height="500" v-loading="listLoading" ref="multipleTable" border fit highlight-current-row :header-cell-style="{background:'oldlace'}">
                    ...
                    <el-table-column prop="fixedAssetCode" align="center" label="固定资产编号" min-width="130">
                    </el-table-column>
                    ...
                    <el-table-column prop="projectExternalName" align="center" label="项目外部名称" min-width="120">
                    </el-table-column>
                    ...
                    <el-table-column prop="changeFixedDate" align="center" label="时间（财务转固）" min-width="140">
                        <template slot-scope="scope">
                            {{scope.row.changeFixedDate!=null?scope.row.changeFixedDate.substring(0,10):''}}
                        </template>
                    </el-table-column>
                    <el-table-column prop="depreciationPeriod" align="center" label="折旧年限（财务）" min-width="140">
                    </el-table-column>
                    ...
                    <el-table-column prop="applyLdleTime" align="center" label="申请闲置日期" min-width="120">
                        <template slot-scope="scope">
                    ...
                    <el-table-column prop="renovationFee" align="center" label="改造费（元）" min-width="120">
                    </el-table-column>
                    <el-table-column prop="originalFinancialValue" align="center" label="财务原值（元）" min-width="120">
                    </el-table-column>
                    <el-table-column prop="netBookValue" align="center" label="账面净值（元）" min-width="120">
                    </el-table-column>
                    ...
                    <el-table-column prop="transferCompany" align="center" label="调拨后所在公司" min-width="120">
                    </el-table-column>
                    <el-table-column prop="transferDivision" align="center" label="调拨使用部门" min-width="120">
                    </el-table-column>
...
<script>
import { fetchNeedList, getDetail, agreeApply, fetchPrint, reCommit, fetchInfoList } from '@/api/procurementRecord/procurementFiling'
...
export default {
    ...
    methods: {
        ...
        getList() {
            ...
            fetchNeedList(this.pageNum,this.pageSize,this.documentWordCode1,this.dctualOrgName).then(response => {
                if (response.data.code === 200) {
        ...
        getNodeKey() {
            getCurrentTask(this.processInstanceId).then(response => {
                if (response.data.code === 200) {
                    ...
                    if (this.nodeKey == "recordpurchase_dsz") { // 董事长审核
                        this.dszShow = false;
                        // this.jsfzrShow = true
                    } else if (this.nodeName == "调整申请") { // 调整申请
                        this.tzsqTask = false;
                        if (this.temp.equipRecordNumList.length === 1) {
                            this.delShow = false;
                        } else {
                    ...
                    } else if (this.nodeKey == "recordpurchase_jtjgb") { // 集团技改办主任
                        this.finance = false; // 预算，设备采购建议、设备采购完成时间
                    } else if (this.nodeKey == "recordpurchase_sybzjl" || this.nodeKey == "recordpurchase_zcb") { //事业部
                        this.xzShow = true; // 查看闲置
                    } else if(this.nodeKey == "recordpurchase_jsfzr"){ // 技术负责人
                        this.jsfzrShow = true // 技术资料
                    } 
                    // else if(this.nodeKey == "recordpurchase_zcb"){ // 资产部审核
                    //     this.finance = false
                    //     this.xzShow = true; // 查看闲置
                    // }
                } else {
        ...
        getFileList() {
            const find = {
                moduleType: "25", // 模块类别
                attachmentCode: "SBBACGSQDQTFJ", // 附件编码
            ...
            const find1 = {
                moduleType: "25", // 模块类别
                attachmentCode: "SBBACGSQDXMFAFJ", // 附件编码
                documentWordCode: this.documentWordCode // 单据编码
            };
        ...
        fileUpload(e) {
            ...
            if (file != null) {
                ...
                this.listLoading = false
                const fileInput1 = document.getElementById("uploadImg");
                fileInput1.value = ''
                })
            }
        },
        ...
        // 董事长审核
        dszAgreeData() {
            this.popData.opinion = null; // 意见
            this.popData.leaderPass = true;
            this.popData.equipBuySuggest = this.temp.equipBuySuggest // 设备采购建议
            ...
            this.popData.projectCode = this.temp.projectCode // 项目号
            this.popData.taskId = this.popData.taskId
            if (this.nodeKey == "recordpurchase_dsz") {
        ...
        agreeData() {
            ...
            this.popData.projectCode = this.temp.projectCode // 项目号
            this.popData.taskId = this.popData.taskId
            if (this.nodeKey == "recordpurchase_jtjgb") { //集团技改办主任
                if (this.popData.budget == null || this.popData.budget == "") {
                    ...
                    return
                }else if(this.popData.equipBuySuggest == '' || this.popData.equipBuySuggest == null){
                    this.$notify({
                        title: "警告",
                        message: "请选择设备采购建议",
                        type: "warning",
            ...
            }else if(this.nodeKey == "recordpurchase_dsz"){ //董事长
                if(this.fileData.length == 0){
                    this.$notify({
                        title: "警告",
                        message: "请上传审核附件",
        ...
        createData() {
            ...
            agreeApply(tempData).then(response => {
                if (response.data.code == 200) {
                    ...
                    this.dialogFormVisible = false;
                    this.getList();
                } else if(response.data.code == 706 && this.nodeKey == 'recordpurchase_jsfzr'){
                    this.$notify({
                        title: "警告",
                        message: '请上传技术资料',
                        type: "warning",
                ...
                // else if(response.data.code == 706 && this.nodeKey == 'recordpurchase_dsz'){
                //     this.$notify({
                //         title: "警告",
                //         message: '请上传审核附件',
                //         type: "warning",
