              ...
              style="width: 100%;min-height:auto;margin-top:0px" height="500" :header-cell-style="{background:'oldlace'}">
               ...
               <el-table-column  align="center" label="序号" min-width="80" type="index"></el-table-column>
                <el-table-column prop="factoryName" align="center" label="使用工厂" min-width="80">
                 ...
                 <el-table-column prop="equipmentNumber" align="center" label="设备台数" min-width="80">
                 </el-table-column>
                 <el-table-column prop="equipOriginalValue" align="center" label="设备原值" min-width="80">
                 </el-table-column>
                 <el-table-column prop="unusedNumber" align="center" label="闲置台数" min-width="80">
                 </el-table-column>
                 <el-table-column prop="unusedValue" align="center" label="闲置总值" min-width="80">
                 </el-table-column>
                  <el-table-column prop="unusedValuePercent" align="center" label="闲置金额占总设备比" min-width="80">
                 </el-table-column>
                  <el-table-column prop="unusedEnableNumber" align="center" label="闲置完好台数" min-width="80">
                 </el-table-column>
                 <el-table-column prop="unusedToDiscardNumber" align="center" label="闲置待报废台数" min-width="80">
                 </el-table-column>
                 <el-table-column prop="toDiscardPercent" align="center" label="待报废占闲置设备比" min-width="80">
                 </el-table-column>
...
<script>
import {fetchList,derivationst,dendrogram}from '@/api/idleProcess/idleStatistics'
import waves from '@/directive/waves' // 水波纹指
import { fetchButton } from '@/api/common/button'//按钮权限
...
export default {
  ...
  methods: {
    ...
    getAA() {
      ...
      if(response.data.code==200){
        if(response.data.data.results!=null && response.data.data!=null){
   ...
   searchsty(){
    ...
    // 导出
    derivation() {
       this.listypp.factoryCode = this.listQuery.factoryCode
       derivationst(this.listypp).then(response => {
