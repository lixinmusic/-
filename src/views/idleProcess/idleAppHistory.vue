...
<script>
import { fetchListdsy, evaluate, circuList, uploadlist, smallAblist, insertFile, updeletedata, getCurrentUser, fetchList, stamplist,derivationst } from '@/api/idleProcess/idleAppHistory'
