          ...
          <center>
            ...
            <tbody>
              ...
              <tr style="height:150px;">
                <td style="position: relative;" colspan="6"><span style="position: absolute;left:5px;top:5px;">申请闲置理由及闲置天数：{{unusedData.applyUnusedReason}};{{unusedData.unusedDays}}</span></td>
              </tr>
...
<script>
import { fetchAllList, getDetail, fetchPrint, fetchExportList } from '@/api/idleProcess/equipIdleApply/equipIdleApply'
