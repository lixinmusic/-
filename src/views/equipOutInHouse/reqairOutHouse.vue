    ...
    <el-container>
      ...
      <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" width="60%" v-dialogDrag :close-on-click-modal="false" v-loading="listLoading"> 
        <el-tabs v-model="activeName">
          <el-tab-pane label="表单信息" name="first">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="110px">
              <el-form-item>
                <span class="equip-title">维修出库单</span>
              </el-form-item>
              <el-row :gutter="20">
                <el-col :span="12">
        ...
        <el-form class="formDw"> 
          <el-form-item>
            ...
            <el-button v-if="dialogStatus=='create'" type="primary" @click="createData">确认出库</el-button>
            <el-button v-if="dialogStatus=='update'" type="primary" @click="updateData">确认出库</el-button>
      ...
      <el-dialog title="选择设备" :visible.sync="centerDialogVisible" width="60%" :close-on-click-modal="false" v-dialogDrag >
        ...
        <el-table :data="infoList" height="360" v-loading="listLoading" 
          ...
          <el-table-column align="center" label="单据编号" prop="formCode"> 
          </el-table-column>
...
<script>
import { fetchList, getDetail, saveFrom, submitForm, delById, fetchInfoList } from '@/api/equipOutInHouse/equipOutInHouse'
...
export default {
  ...
  methods: {
    ...
    importOk() {
      ...
      this.temp.transferOutCompany = this.multipleSelection.transferOutCompany
