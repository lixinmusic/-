        ...
        <div class="filter-container">
            ...
            <el-form :inline="true">
                ...
                <el-form-item label="审核状态">
                    <el-select v-model="listQuery.auditingType" clearable style="width:213px"  placeholder="请选择">
                    <el-option
...
<script>
import { fetchList, smallAblist, uploadlist, circuList, updeletedata, derivationst } from '@/api/equipMent/newReceHistory'
