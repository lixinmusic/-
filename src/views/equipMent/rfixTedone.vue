            ...
            <el-tab-pane label="流转记录" name="second">
             ...
             <el-table :data="circulation" v-loading="listLoading" border fit highlight-current-row
              style="width: 100%;min-height:auto;margin-top:8px" :header-cell-style="{background:'oldlace'}">
               ...
               <el-table-column prop="taskName" align="center" label="步骤名" min-width="107">
                ...
                <el-table-column prop="userName" align="center" label="操作人" min-width="98">
                ...
                <el-table-column prop="orgName" align="center" label="所在部门" min-width="98">
                ...
                <el-table-column prop="stationName" align="center" label="岗位" min-width="98">
                 ...
                 <el-table-column prop="state" align="center" label="状态" min-width="98">
                 ...
                 <el-table-column prop="opinion" align="center" label="意见" min-width="98">
                ...
                <el-table-column prop="dateTime" align="center" label="时间" min-width="157">
                 <template slot-scope="scope">
                 <span>{{scope.row.dateTime}}</span>
                 </template>
                </el-table-column>

                <el-table-column prop="remark" align="center" label="备注" min-width="157">
                 <template slot-scope="scope">
...
<script>
import { fetchList, smallAblist, samllDelete, uploadlist, circuList, updeletedata } from '@/api/equipMent/rfixTedone'
  ...
  data() {
    return {
      ...
      rules: {
        ...
        warrantyAcceptanceTime: [{ required: true, message: '请输入', trigger: 'change' }],
