        ...
        <el-tabs v-model="activeName" v-loading="fromLoading"  @tab-click="fathClick"><!-- @tab-click="handleClick" -->
          ...
          <!-- 选项卡表格 -->
            <el-form :rules="rules" ref="dataForm" :model="temp" label-width="110px">
              ...
              <el-input v-model="temp.serialNumber" :disabled='siteCodeState?true:false' style="width:190px" class="enter medium-input" placeholder="请引用新增设备一览表" ></el-input>   
              </el-form-item>
              </el-col>
              </el-row>
...
<script>
import { fetchList,smallAblist,samllDelete,uploadlist,circuList,updateAuditing} from '@/api/equipMent/pacceptanceDone'
import {flowsheet} from '@/api/equipMent/acceptanceSheet'
import waves from '@/directive/waves' // 水波纹指
export default {
  name: 'pacceptanceDone',
  directives: {
    waves
  },
  data() {
