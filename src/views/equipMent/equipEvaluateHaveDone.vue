              ...
              <el-row>
                ...
                <el-col :span="12">
                  <el-form-item label="不通过原因" prop="noPassReason">
                    <el-input v-model="temp.noPassReason" type="textarea" style="margin-bottom:5px" disabled></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
...
<script>
import { fetchDoneList, getDetail } from '@/api/equipMent/equipEvaluateForm/equipEvaluateForm'
import { commonOptions1, recordList, fileList, processChart } from '@/api/common/common'
import { baseUrl } from '@/api/common/fileBaseUrl'
export default {
  name: 'equipEvaluateHaveDone',
  data() {
    return {
      // 表格数据
      chartData: null, // 流程图
