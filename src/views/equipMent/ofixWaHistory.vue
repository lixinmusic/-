      ...
      <!-- 内容容器 -->
        ...
        <el-tabs v-model="activeName" v-loading="fromLoading"  @tab-click="fathClick"><!-- @tab-click="handleClick" -->
             ...
             <el-table :data="circulation" v-loading="listLoading" border fit highlight-current-row
              style="width: 100%;min-height:auto;margin-top:8px" :header-cell-style="{background:'oldlace'}">
               ...
               <el-table-column prop="taskName" align="center" label="步骤名" min-width="83">
                ...
                <el-table-column prop="remark" align="center" label="备注" min-width="128">
                 <template slot-scope="scope">
          ...
          <el-tree :data="datast" :props="defaultProps" default-expand-all @node-click="handleNodeClick" check-strictly ref="tree" node-key="orgCode" highlight-current @check-change="handleClick"></el-tree>
           ...
           <el-tree :data="plantlisy" :props="terrplant" default-expand-all @node-click="handleNodeClickworks" check-strictly ref="treeplisy" node-key="orgCode" highlight-current @check-change="hocheckck"></el-tree>
           </el-aside>
	         </el-container>
           <div slot="footer" class="dialog-footer">
...
<script>
import { fetchList, smallAblist, samllDelete, uploadlist, circuList, updeletedata,derivationst } from '@/api/equipMent/ofixWaHistory'
