...
<script>
import { fetchListdsy, updateArticle, evaluate, producePv, circuList, uploadlist, smallAblist, createArticlest, deleteapp, updeletedata, insertFile, getCurrentUser, fixedascode } from '@/api/equipMent/newReceiving'
  ...
  data() {
    return {
      ...
      rules: {
        ...
        acceptanceFinishTime: [{ required: true, message: '请选择', trigger: 'change' }],
