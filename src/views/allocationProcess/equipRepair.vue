    ...
    <el-container>
      ...
      <el-dialog title="选择设备" :visible.sync="centerDialogVisible" width="80%" :close-on-click-modal="false" v-dialogDrag>
        ...
        <el-table :data="infoList" height="360" v-loading="listLoading" 
          ...
          <!-- <el-table-column prop="repairCompany" align="center" label="报修公司"  min-width="120">
          </el-table-column>
          ...
          <el-table-column prop="serialNumber" align="center" label="出厂编号" min-width="120">
          </el-table-column>
          <el-table-column prop="manufacturer" align="center" label="制造厂家" min-width="120">
          </el-table-column>
          <!-- <el-table-column prop="repairFactory" align="center" label="维修厂商" min-width="120">
          </el-table-column>
          <el-table-column prop="aloofFactoryDate" align="center" label="出厂时间" min-width="120">
            <template slot-scope="scope">
            {{scope.row.aloofFactoryDate!==null?scope.row.aloofFactoryDate.substring(0,10):''}}
            </template>
          </el-table-column>
          ...
          <el-table-column prop="invoiceDate" align="center" label="发票时间" min-width="80">
            <template slot-scope="scope">
            {{scope.row.invoiceDate!==null?scope.row.invoiceDate.substring(0,10):''}}
            </template>
          </el-table-column> -->         
        </el-table>
        <div class="pagination-container">
          ...
          <table border= "0">
            ...
            <tbody>
              ...
              <tr style="text-align:left">
                ...
                <!-- <td colspan="2" style="text-align:left">经办人：{{printList.bmjl}}</td> -->
...
export default {
  ...
  methods: {
    ...
    importOk() {
      ...
      this.temp.transferOutCompany = this.multipleSelection.repairCompany
