          ...
          <el-main style="padding:20px 0px">
            ...
            <el-table :data="lookList" v-loading="listLoading" border fit highlight-current-row
              ...
              <el-table-column prop="factoryName" align="center" label="使用工厂" min-width="80">
               ...
               <!--  <el-table-column label="新设备1周试用质量报告计划及时率" align="center">
                <el-table-column prop="total" align="center" label="总项数" min-width="80">
                 <template slot-scope="scope">
                  {{scope.row.oneWeek.total}}
                  </template>
                </el-table-column>
                <el-table-column prop="passNum" align="center" label="及时项数" min-width="80">
                 <template slot-scope="scope">
                  {{scope.row.oneWeek.passNum}}
                  </template>
                </el-table-column>
                <el-table-column prop="unPassNum" align="center" label="不及时项数" min-width="80">
                 <template slot-scope="scope">
                  {{scope.row.oneWeek.unPassNum}}
                  </template>    
                </el-table-column>
                <el-table-column prop="passRatio" align="center" label="验收及时率" min-width="80">
                <template slot-scope="scope">
                  {{scope.row.oneWeek.passRatio}}
                </template>    
                </el-table-column>
                <el-table-column prop="averageDays" align="center" label="平均延期天数" min-width="80">
                 <template slot-scope="scope">
                  {{scope.row.oneWeek.averageDays}}
                </template>   
                </el-table-column>
                </el-table-column> -->

             <el-table-column label="新设备评价报告计划及时率" align="center">
               <el-table-column prop="total" align="center" label="总项数" min-width="80">
                 <template slot-scope="scope">
                  {{scope.row.oneMonth.total}}
                  </template>
                </el-table-column>
                <el-table-column prop="passNum" align="center" label="及时项数" min-width="80">
                 <template slot-scope="scope">
                  {{scope.row.oneMonth.passNum}}
                  </template>
                </el-table-column>
                <el-table-column prop="unPassNum" align="center" label="不及时项数" min-width="80">
                 <template slot-scope="scope">
                  {{scope.row.oneMonth.unPassNum}}
                  </template>    
                </el-table-column>
                <el-table-column prop="passRatio" align="center" label="验收及时率" min-width="80">
                <template slot-scope="scope">
                  {{scope.row.oneMonth.passRatio}}
                </template>    
                </el-table-column>
                <el-table-column prop="averageDays" align="center" label="平均延期天数" min-width="80">
                 <template slot-scope="scope">
                  {{scope.row.oneMonth.averageDays}}
                </template>   
                </el-table-column>
                </el-table-column>

                <el-table-column label="新设备验计划及时率" align="center">
                <el-table-column prop="total" align="center" label="总项数" min-width="80">
                 <template slot-scope="scope">
                  {{scope.row.threeMonth.total}}
                  </template>
                </el-table-column>
                <el-table-column prop="passNum" align="center" label="及时项数" min-width="80">
                 <template slot-scope="scope">
                  {{scope.row.threeMonth.passNum}}
                  </template>
                </el-table-column>
                <el-table-column prop="unPassNum" align="center" label="不及时项数" min-width="80">
                 <template slot-scope="scope">
                  {{scope.row.threeMonth.unPassNum}}
                  </template>    
                </el-table-column>
                <el-table-column prop="passRatio" align="center" label="验收及时率" min-width="80">
                <template slot-scope="scope">
                  {{scope.row.threeMonth.passRatio}}
                </template>    
                </el-table-column>
                <el-table-column prop="averageDays" align="center" label="平均延期天数" min-width="80">
                 <template slot-scope="scope">
                  {{scope.row.threeMonth.averageDays}}
                </template>   
                </el-table-column>
                </el-table-column>

                <el-table-column label="设备质保验收计划及时率" align="center">
                <el-table-column prop="total" align="center" label="总项数" min-width="80">
                 <template slot-scope="scope">
                  {{scope.row.twelveMonth.total}}
                  </template>
                </el-table-column>
                <el-table-column prop="passNum" align="center" label="及时项数" min-width="80">
                 <template slot-scope="scope">
                  {{scope.row.twelveMonth.passNum}}
                  </template>
                </el-table-column>
                <el-table-column prop="unPassNum" align="center" label="不及时项数" min-width="80">
                 <template slot-scope="scope">
                  {{scope.row.twelveMonth.unPassNum}}
                  </template>    
                </el-table-column>
                <el-table-column prop="passRatio" align="center" label="验收及时率" min-width="80">
                <template slot-scope="scope">
                  {{scope.row.twelveMonth.passRatio}}
                </template>    
                </el-table-column>
                <el-table-column prop="averageDays" align="center" label="平均延期天数" min-width="80">
                 <template slot-scope="scope">
                  {{scope.row.twelveMonth.averageDays}}
                </template>   
                </el-table-column>
                </el-table-column>  
...
<script>
import { fetchList, derivationst, dendrogram, section } from '@/api/acceptanceTable/vsummarySurface'
import waves from '@/directive/waves' // 水波纹指令
import { fetchButton } from '@/api/common/button'
import { menuList } from '@/store/modules/permission'//按钮权限

export default {
  name: 'vsummarySurface',
  directives: {
    waves
  },
  data() {
