       ...
       <!-- 顶部搜索 -->
        ...
        <div class="filter-container">
            ...
            <el-form :inline="true">
                ...
                <el-form-item label="新设备评价试用评价实际完成时间">
                <div class="block">
                    <el-date-picker
                    style="width:230px"
                    v-model="value13"
                ...
                <el-form-item label="新设备验收要求完成时间">
                <div class="block">
                    <el-date-picker
                    style="width:230px"
                    v-model="weekdates"
               ...
               <el-form-item label="验收初验验收完成情况" v-model="listQuery.isComplete">
            ...
            <el-table :data="listyst" v-loading="listLoading" border fit highlight-current-row
              ...
              <el-table-column prop="factoryName" align="center" label="使用工厂" min-width="80">
               ...
               <el-table-column prop="contractNumber" align="center" label="合同编号" min-width="80">
                ...
                <el-table-column prop="realTime" align="center" label="新设备评价试用实际完成时间" min-width="80">
                <template slot-scope="scope">
                  {{scope.row.realTime}}
                 </template>
                 </el-table-column>
                <el-table-column prop="requestTime" align="center" label="新设备验收要求完成时间" min-width="80">
                <template slot-scope="scope">
...
<script>
import { fetchList, derivationst } from '@/api/acceptanceTable/threeMonth'
