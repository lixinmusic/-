     ...
     <!--  -->
        <div class="filter-container">
            ...
            <el-form :inline="true">
                ...
                <el-form-item label="新设备评价试用评价要求完成时间" >
                <div class="block">
                    <el-date-picker
                    style="width:230px"
                    v-model="weekdates"
               ...
               <el-form-item label="评价验收完成情况" v-model="listQuery.isComplete">
            ...
            <el-table :data="listyst" v-loading="listLoading" border fit highlight-current-row
              ...
              <el-table-column prop="factoryName" align="center" label="使用工厂" min-width="80">
               ...
               <el-table-column prop="contractNumber" align="center" label="合同编号" min-width="80">
                ...
                <el-table-column prop="requestTime" align="center" label="新设备评价试用评价要求完成时间" min-width="80">
                <template slot-scope="scope">
...
<script>
import { fetchList, derivationst } from '@/api/acceptanceTable/januarySchedule'
import waves from '@/directive/waves' // 水波纹指令
import { fetchButton } from '@/api/common/button'
import { menuList } from '@/store/modules/permission'//按钮权限

export default {
  name: 'januarySchedule',
  directives: {
    waves
  },
  data() {
