              ...
              <el-table-column prop="factoryName" align="center" label="使用工厂" min-width="80">
               ...
               <el-table-column prop="divisionName" align="center" label="使用部门" min-width="80">
                ...
                <el-table-column prop="installationCompleted" align="center" label="改造安装完成时间" min-width="80">
                 ...
                 <el-table-column label="改造验收" align="center"> 
                  <el-table-column prop="acceptanceShouldTime" align="center" label="要求完成时间" min-width="80">
                    <template slot-scope="scope">
                  {{scope.row.acceptanceShouldTime}}
                  </template>
                  </el-table-column>
                  <el-table-column prop="realAcceptanceShouldTime" align="center" label="实际完成时间" min-width="80">
                   <template slot-scope="scope">
                  {{scope.row.realAcceptanceShouldTime}}
                  </template>
                  </el-table-column> 
                  <el-table-column prop="acceptanceShouldDeferredDays" align="center" label="评价延期天数" min-width="80">
                 </el-table-column>
             </el-table-column>

             <el-table-column label="改造质保验收" align="center"> 
                  <el-table-column prop="warrantyShouldTime" align="center" label="要求完成时间" min-width="80">
                    <template slot-scope="scope">
                  {{scope.row.warrantyShouldTime}}
                  </template>
                  </el-table-column>
                  <el-table-column prop="realWarrantyShouldTime" align="center" label="实际完成时间" min-width="80">
                   <template slot-scope="scope">
                  {{scope.row.realWarrantyShouldTime}}
                  </template>
                  </el-table-column> 
                  <el-table-column prop="warrantyShouldDeferredDays" align="center" label="评价延期天数" min-width="80">
                 </el-table-column>
             </el-table-column>
            </el-table>
          </el-main>
...
<script>
import { fetchList, derivationst, dendrogram, section,works } from '@/api/abrentionPlan/planCompleted'
