       ...
       <!-- 顶部搜索 -->
        ...
        <div class="filter-container">
            ...
            <el-form :inline="true">
                ...
                <el-form-item label="设备改造验收实际完成时间">
                <div class="block">
                    <el-date-picker
                    style="width:230px"
                    v-model="value13"
                ...
                <el-form-item label="设备改造质保验收要求完成时间">
                <div class="block">
                    <el-date-picker
                    style="width:230px"
                    v-model="weekdates"
               ...
               <el-form-item label="设备改造质保验收完成情况" v-model="listQuery.reformInfo">
            ...
            <el-table :data="listyst" v-loading="listLoading" border fit highlight-current-row
              ...
              <el-table-column prop="factoryName" align="center" label="使用工厂" min-width="80">
               ...
               <el-table-column prop="supplier" align="center" label="改造供应商" min-width="80">
                ...
                <el-table-column prop="startDate" align="center" label="设备改造验收实际完成时间" min-width="80">
                <template slot-scope="scope">
                  {{scope.row.startDate}}
                 </template>
                 </el-table-column>
                <el-table-column prop="endDate" align="center" label="设备改造质保验收要求完成时间" min-width="80">
                <template slot-scope="scope">
                  {{scope.row.endDate}}
                 </template>
                 </el-table-column>   
...
<script>
import { fetchList, derivationst } from '@/api/abrentionPlan/qualityReform'
  ...
  methods: {
    ...
    defaultime(){
      ...
      if(26>dt){
        ...
        this.listQuery.warrantyShouldTimeStart = this.weekdates[0]// 开始时间
        this.listQuery.warrantyShouldTimeEnd = this.weekdates[1]
        //  导出
        this.listQueryst.warrantyShouldTimeStart = this.weekdates[0]
        this.listQueryst.warrantyShouldTimeEnd = this.weekdates[1]
    ...
    searchsty() {
      if (this.value13 == null) {
        this.listQuery.realAcceptanceShouldTimeStart = ''
        this.listQuery.realAcceptanceShouldTimeEnd = ''
      } else {
        this.listQuery.realAcceptanceShouldTimeStart = this.value13[0]// 开始时间
        this.listQuery.realAcceptanceShouldTimeEnd = this.value13[1]
      }
      if (this.weekdates == null) {
        this.listQuery.warrantyShouldTimeStart = ''
        this.listQuery.warrantyShouldTimeEnd = ''
      } else {
        this.listQuery.warrantyShouldTimeStart = this.weekdates[0]// 开始时间
        this.listQuery.warrantyShouldTimeEnd = this.weekdates[1]
      }
