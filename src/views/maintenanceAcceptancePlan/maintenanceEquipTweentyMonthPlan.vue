        ...
        <div class="filter-container">
            <div class="formSearch">
				<el-form :inline="true">
					...
					<el-row>
						<el-col :span="6">
							<el-form-item label="维修验收试用评价实际完成时间" >
								<div class="block">
									<el-date-picker
									style="width:230px"
									v-model="value13"
						...
						<el-col :span="7">
							<el-form-item label="维修质保验收试用评价要求完成时间">
								<div class="block">
									<el-date-picker
						...
						<el-col :span="6" style="margin-top:2px">
							<el-form-item label="维修质保验收完成情况" v-model="listQuery.status">
        ...
        <el-main style="padding:20px 0px">
            ...
            <el-table :data="listData" v-loading="listLoading" border fit highlight-current-row
              style="width: 100%;min-height:auto;margin-top:8px" height="500" :header-cell-style="{background:'oldlace'}">
                ...
                <el-table-column prop="unpackingDate" align="center" label="维修验收试用评价实际完成时间" min-width="150">
					<template slot-scope="scope">
						<span>{{scope.row.realTime}}</span>
					</template>
                </el-table-column>

                <el-table-column prop="requestTime" align="center" label="维修质保验收试用评价要求完成时间" min-width="150">
					<template slot-scope="scope">
...
<script>
import { fetchList, exportList } from "@/api/maintenanceAcceptancePlan/maintenanceEquipTweentyMonthPlan";
	...
	methods: {
		...
		getButton() {
			menuList.forEach(item => {
				...
				if(e.name == "maintenanceEquipTweentyMonthPlan"){
