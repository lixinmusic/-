...
<script>
import { getMenusWeb, createArticle, deleteBtnById, updateArticle, filterWeb } from '@/api/system/sysButton'
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        buttonName: [{ required: true, message: '请输入菜单名称', trigger: 'change' }],
