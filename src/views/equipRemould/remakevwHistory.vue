            ...
            <el-form :inline="true">
               ...
               <el-form-item label="固定资产编号" >
                ...
                <el-form-item label="审核状态">
                    <el-select v-model="listQuery.auditingType" clearable style="width:190px"  placeholder="请选择">
                    <el-option
            ...
            <el-table :data="listyst" v-loading="listLoading" border fit highlight-current-row
              ...
              <el-table-column prop="documentWordCode" align="center" label="单据编码"  min-width="100">
               ...
               <el-table-column prop="reformSupplier" align="center" label="改造供应商" min-width="80">
                ...
                <el-table-column prop="formCode" align="center" label="改造记录编号" min-width="80">
                 </el-table-column>
               ...
               <el-table-column prop="acceptanceSituationName" align="center" label="质保验收情况" min-width="80">
                 </el-table-column>
               ...
               <el-table-column prop="warrantyAcceptanceTime" align="center" label="质保验收日期" min-width="80">
                  ...
                  <el-table-column prop="reformContent" align="center" label="改造内容" min-width="80">
                 </el-table-column>
          ...
          <!-- 选项卡表格 -->
            <el-form :rules="rules" ref="dataForm" :model="temp" label-width="110px">
             ...
             <el-row>
              ...
              <el-input v-model="temp.reformSupplier" :disabled='siteCodeState?true:false' style="width:290px" class="enter medium-input" placeholder="请输入改造供应商" ></el-input>   
              </el-form-item>
              </el-col>
              <el-col :span="16">
              ...
              <el-row>
              <el-col :span="10">     
              <el-form-item label="质保验收完成时间" prop="warrantyAcceptanceTime" label-width="130px">
               <div class="block">
                <el-date-picker
                  style="width:270px"
              ...
              <el-col :span="14">
              <el-form-item label="验收情况" prop="acceptanceSituation" style="margin-left:95px" :disabled='siteCodeState?true:false'> 
              ...
              <el-row>
              <el-col :span="18">
            <el-form-item label="设备质保验收单附件" class="sepost" label-width="140px">
              </el-form-item>
              </el-col>
               </el-row> 
              <!-- 第一个小表格 -->
...
<script>
import { fetchList, smallAblist, samllDelete, uploadlist, circuList, updateAuditing, updeletedata,derivationst } from '@/api/equipRemould/remakevwHistory'
...
// ******* 文件预览结束**********
    ...
    // 使用部门清空按钮
    clearsection() {
      this.listQuery.useWorkshop = ''
      this.postyly = ''
      this.treeDepartment = false
    },
    // 使用工厂清空按钮
    poacksty() {
      this.listQuery.useFactory = ''
      this.yesno = ''
      this.revealspo = ''
    ...
    // 确定的按钮使用公司
    queshlo() {
      this.listQuery.useCompany = this.factoryscod
    ...
    // 确认按钮使用工厂
    affirmspo() {
      this.listQuery.useFactory = this.firmcod
    ...
    handleClick2() {
      ...
      this.listQuery.useWorkshop = this.getOrgCode
