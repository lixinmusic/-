        ...
        <el-tabs v-model="activeName" v-loading="fromLoading" @tab-click="fathClick"><!-- @tab-click="handleClick" -->
          ...
          <!-- 选项卡表格 -->
            <el-form :rules="rules" ref="dataForm" :model="temp" label-width="110px">
              ...
              <el-col :span="14">
              <el-form-item label="验收情况" prop="acceptanceSituation" :disabled='kstylsty?true:false' style="margin-left:95px"> 
...
<script>
import { fetchList, smallAblist, samllDelete, uploadlist, circuList, updateAuditing, updeletedata, insertFile, getCurrentUser, getNodeTask, newlYupdate } from '@/api/equipRemould/remakevwatoBedone'
