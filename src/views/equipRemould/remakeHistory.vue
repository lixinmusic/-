            ...
            <el-form :inline="true">
               ...
               <el-form-item label="固定资产编号" >
                ...
                <el-form-item label="审核状态">
                    <el-select v-model="listQuery.checkStatus" clearable style="width:213px"  placeholder="请选择">
                    <el-option
          ...
          <el-main style="padding:20px 0px">
            ...
            <el-table :data="listyst" v-loading="listLoading" border fit highlight-current-row
              ...
              <el-table-column prop="formCode" align="center" label="单据编码"  min-width="100">
               ...
               <el-table-column prop="reformCode" align="center" label="改造记录编号" min-width="80">
                 </el-table-column>
        ...
        <el-tabs v-model="activeName" v-loading="fromLoading" @tab-click="fathClick"><!-- @tab-click="handleClick" -->
          ...
          <!-- 选项卡表格 -->
            <el-form :rules="rules" ref="dataForm" :model="temp" label-width="110px">
             ...
             <el-col :span="10">
              <el-form-item label="验收情况" prop="warrantyType"> 
                <el-radio v-model="temp.warrantyType" label="0" disabled>验收通过</el-radio>
                <el-radio v-model="temp.warrantyType" label="1" disabled>验收不通过</el-radio>
                </el-form-item>
              </el-col>
              <el-col :span="14">     
...
<script>
import { fetchList, smallAblist, samllDelete, uploadlist, circuList, updateAuditing, updeletedata,derivationst } from '@/api/equipRemould/remakeHistory'
...
// ******* 文件预览结束**********
    ...
    alltiemw() {
      ...
      this.listQuery.checkStatus = this.posyrouter.checkStatus
