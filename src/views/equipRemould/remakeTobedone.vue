        ...
        <el-tabs v-model="activeName" v-loading="fromLoading" @tab-click="fathClick"><!-- @tab-click="handleClick" -->
          ...
          <!-- 选项卡表格 -->
            <el-form :rules="rules" ref="dataForm" :model="temp" label-width="110px">
              ...
              <el-input v-model="temp.supplier" :disabled='siteCodeState?true:false' style="width:290px" class="enter medium-input" placeholder="请输入改造供应商" ></el-input>
              </el-form-item>
              </el-col>
              <el-col :span="16">     
              <el-form-item label="使用公司"  prop="companyName" style="margin-left:200px;">
              <el-input style="width:290px" v-model="temp.companyName" :disabled='siteCodeState?true:false' class="enter medium-input" placeholder="输入使用公司" ></el-input>
              </el-form-item>
              </el-col>
              </el-row>
              ...
              <el-form-item label="改造内容" prop="context" label-width="120px">
               ...
               <el-row> 
               <el-col :span="10">
              <el-form-item label="验收情况" prop="warrantyType" :disabled='kstylsty?true:false'> 
                <el-radio v-model="temp.warrantyType" :disabled='kstylsty?true:false' label="0">验收通过</el-radio>
                <el-radio v-model="temp.warrantyType" :disabled='kstylsty?true:false' label="1">验收不通过</el-radio>
                </el-form-item>
              </el-col>
              <el-col :span="14">     
              ...
              <el-form-item label="设备改造记录单附件" class="sepost" label-width="140px">
...
<script>
import { fetchList, smallAblist, samllDelete, uploadlist, circuList, updateAuditing, updeletedata, insertFile, getCurrentUser, getNodeTask, newlYupdate } from '@/api/equipRemould/remakeTobedone'
