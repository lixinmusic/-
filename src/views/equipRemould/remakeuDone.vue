            ...
            <el-form :inline="true">
                ...
                <div class="block">
                 ...
                 <el-form-item label="审核状态">
                    <el-select v-model="listQuery.checkStatus" style="width:213px" clearable  placeholder="请选择">
                    <el-option
          ...
          <el-main style="padding:20px 0px">
            <el-table :data="listyst" v-loading="listLoading" border fit highlight-current-row
              style="width: 100%;min-height:auto;margin-top:0px" height="500" :header-cell-style="{background:'oldlace'}">
               ...
               <el-table-column prop="warrantyType" align="center" label="验收情况" min-width="80">
                <template slot-scope="scope">
                     {{scope.row.warrantyType ==0?'验收通过':'验收不通过'}}
                 </template>
                 </el-table-column>
          ...
          <!-- 选项卡表格 -->
            <el-form :rules="rules" ref="dataForm" :model="temp" label-width="110px">
              ...
              <el-form-item label="改造内容" prop="context" label-width="120px">
               ...
               <el-row>
              <el-col :span="10">
              <el-form-item label="验收情况" prop="warrantyType" :disabled='siteCodeState?true:false'> 
                <el-radio v-model="temp.warrantyType" :disabled='siteCodeState?true:false' label="0">验收通过</el-radio>
                <el-radio v-model="temp.warrantyType" :disabled='siteCodeState?true:false' label="1">验收不通过</el-radio>
                </el-form-item>
              </el-col>
              <el-col :span="14">     
...
<script>
import { fetchList, smallAblist, samllDelete, uploadlist, circuList, updateAuditing, updeletedata } from '@/api/equipRemould/remakeuDone'
  ...
  data() {
    return {
      ...
      rules: {
       ...
       evaluateTime: [{ required: true, message: '请输入日期', trigger: 'change' }] 
      },
