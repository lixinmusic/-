...
export function derivationst(data) {
  return request({
    url: MES_EQUIPMENT + 'equipment/account/getExportPath' + "?random=" + Math.random(),
    method: 'post',
    data
  })
}
...
export function updateArticle(data) {
  return request({
    url: MES_EQUIPMENT + 'equipment/account/up',
    method: 'put',
    data
  })
}
...
// 改造历史
export function remekHistory(query) {
  return request({
    url: MES_EQUIPMENT + 'equipment/equipreformrecord/reformHistory',
    method: 'get',
    params: query
  })
}