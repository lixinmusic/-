...
export function fetchListdsy(pageNum, pageSize,data) {
  return request({
    url: MES_EQUIPMENT + 'equipment/repair/doucument/getAlready' + '?pageNum=' + pageNum + '&pageSize=' + pageSize,
    method: 'post',
    data
  })
}
...
export function postMessage(query) {
  return request({
    url: MES_EQUIPMENT + "equipment/repair/doucument/sendNoticeMessage",
    method: "get",
    params: query
  });
}