...
export function fetchList(pageNum, pageSize, data) {
    return request({
      url: MES_EQUIPMENT + "equipment/repair/quality/getUpcoming" + "?pageNum=" + pageNum + "&pageSize=" + pageSize,
      method: "post",
      data
    });
}
...
export function updateAuditing(query) {
    return request({
      url: MES_EQUIPMENT + "equipment/repair/quality/operating",
      method: "get",
      params: query
    });
}
...
export function newlYupdate(data) {
    return request({
      url: MES_EQUIPMENT + "equipment/repair/quality/reInitiate",
      method: "post",
      data
    });
}
