...
export function fetchList(pageNum, pageSize, data) {
    return request({
        url: MES_EQUIPMENT + "equipment/repair/acceptance/getDataByParam" + "?pageNum=" + pageNum + "&pageSize=" + pageSize,
        method: "post",
        data
    });
}
...
export function derivationst(data) {
    return request({
        url: MES_EQUIPMENT + "equipment/repair/acceptance/getDetailExportPath",
        method: "post",
        data
    });
}
