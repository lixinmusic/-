...
export function fetchList(data) {
    return request({
        url: MES_EQUIPMENT + 'equipment/equipreformwarranty/selectNeedDoReformWarrantyByParam',
        method: 'post',
        data
    })
}
...
// 同意按钮和退回按钮  PUT /equipment/equipreformwarranty/updateAuditing
export function updateAuditing(data) {
    return request({
        url: MES_EQUIPMENT + 'equipment/equipreformwarranty/updateAuditing',
        method: 'put',
        data
    })
}
...
export function newlYupdate(data) {
    return request({
      url: MES_EQUIPMENT + "equipment/equipreformwarranty/reCommit",
      method: "put",
      data
    });
}
