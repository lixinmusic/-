...
export function fetchList(query) {
  return request({
    url: MES_EQUIPMENT + "equipment/reformWarrantyAcceptance/listEquipWarrantyNoUser",
    method: "get",
    params: query
  });
}
...
export function derivationst(query) {
  return request({
    url:MES_EQUIPMENT + "equipment/reformWarrantyAcceptance/listEquipWarrantyNoUserExport",
    method: "get",
    params: query
  });
}
