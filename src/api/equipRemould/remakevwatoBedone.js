...
export function fetchList(query) {
    return request({
      url: MES_EQUIPMENT + "equipment/reformWarrantyAcceptance/listNeedle",
      method: "get",
      params: query
    });
}
...
export function newlYupdate(data) {
    return request({
        url: MES_EQUIPMENT + "equipment/reformWarrantyAcceptance/update",
        method: "put",
        data
    });
}
...
export function updateAuditing(data) {
    return request({
        url: MES_EQUIPMENT + 'equipment/reformWarrantyAcceptance/completeTask',
        method: 'put',
        data
    })
}
