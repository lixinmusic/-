...
export function fetchList(query) {
  return request({
    url: MES_EQUIPMENT+'equipment/warranty/listNeedDoWarrantyByTerm',
    method: 'get',
    params: query
  })
}
...
export function updateAuditing(data) {
  return request({
    url: MES_EQUIPMENT+'equipment/warranty/updateAuditing',
    method: 'put',
    data
  })
}
...
export function newlYupdate(data) {
  return request({
    url: MES_EQUIPMENT + 'equipment/warranty/ReCommitWarranty',
    method: 'put',
    data
  })
}
