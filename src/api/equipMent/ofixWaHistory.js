...
export function fetchList(query) {
    return request({
      url: MES_EQUIPMENT + "equipment/warranty/listEquipWarrantyNoUser",
      method: "get",
      params: query
    });
}
...
// 查看里的小表格接口 equipment/file/listFlowFile
...
export function derivationst(query) {
    return request({
        url: MES_EQUIPMENT + "equipment/warranty/listEquipWarrantyNoUserExport",
        method: "get",
        params: query
    });
}
